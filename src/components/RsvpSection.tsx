...
const GOOGLE_SHEETS_API_KEY = "AKfycbxSCD30mvKnlZ0CStUMXofIv1Iz1EN3RCQdj2Km1lGXKPC1aGcjfMn6NVXBIF7qnw3caQ";
...
export default function RsvpSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!GOOGLE_SHEETS_ENDPOINT) {
      console.error('Missing Google Sheets endpoint configuration');
