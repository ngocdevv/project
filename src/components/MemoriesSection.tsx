...
import ta05435Image from "../assets/images/TA_05435.jpg";
import ta05356Image from "../assets/images/TA_05356.jpg";
import ta05780Image from "../assets/images/TA_05780.jpg";
import ta05801Image from "../assets/images/TA_05801.jpg";
import ta05873Image from "../assets/images/TA_05873.jpg";
import ta06557Image from "../assets/images/TA_06557.jpg";
  ...
  return (
    <div className="ml-auto mr-auto relative h-[1500.2px]">
      ...
      <div className="h-full ml-auto mr-auto relative">
        ...
        <div className="absolute w-[390px] left-[-8px] top-[28.6px]">
          <p
            className="bg-center bg-cover inline-block text-center w-full text-white text-[34px] leading-[86.4px]"
            style={{
              fontFamily:
        ...
        <div className="absolute w-[379px] left-[20.5px] top-[114.6px]">
          ...
          >
            Từ những ngày tuổi trẻ đầy ước mơ đến khoảnh khắc cùng nhau hứa trọn đời — hành trình của chúng mình là những thước phim ngọt ngào, đong đầy yêu thương. Mỗi nụ cười, mỗi ánh nhìn đều là kỷ niệm đẹp mà chúng mình luôn trân quý. Giữa vòng tay của gia đình và bạn bè, chúng mình bắt đầu một hành trình mới — vẫn nắm tay nhau, như thuở ban đầu.
          </p>
        </div>
        ...
        <div className="absolute w-[229px] h-[389px] left-[20.5px] top-[526.2px]">
          <div
            className="bg-origin-content bg-top bg-cover size-full overflow-hidden absolute shadow-[rgb(31,33,36)_0px_13px_20px_-17px]"
            style={{
              backgroundImage: `url(${ta05435Image})`,
            }}
          ></div>
        </div>
